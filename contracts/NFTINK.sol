...
// // NFT token where you can create and mint NFT's

// // missing functionality:
// // - set price or let people bid on nft
// // - let user buy nft (we should exchange nft against our main token (BEP20 token))
// // - let creator of NFT update the NFT (price, any information basically)

// // - This contract is right now deployed and we play with it on the frontend
...
//     constructor() public ERC721("Nifty Ink", "NFTINK") {
...
//     function createInk(string memory jsonUrl, uint256 limit)
//         public
//         returns (uint256)
//     {
...
//     function inkTokenByIndex(string memory jsonUrl, uint256 index)
//         public
//         view
//         returns (uint256)
//     {
...
//     function inkInfoByJsonUrl(string memory jsonUrl)
//         public
//         view
//         returns (
//             uint256,
